    ...
    <div class="modal animate__animated animate__fadeIn">
        <div class="wrapper w100 row no-wrap justify-center">
            <q-card class="q-ma-md q-pa-sm  ">
                <q-card-section>
                    <h5 class="text-primary">Adicionar Produto</h5>
                    <div class="inputs-banner w100 column q-gutter-y-md q-mt-xs">
                        ...
                        <div class="row w100 no-wrap">
                            ...
                            <q-input  v-if="promo  && promo.value === true" class="w40" v-model="valorPromocional" reverse-fill-mask prefix="R$" maxlength="8"  mask="#####,##" label="Valor Novo*"/>
                        </div>
...
const valorPromocional = ref(null);
